...
export type PlayerAction =
  ...
  // Single attacker (Vassal vs Vassal, or Colossus vs Colossus):
  | { type: 'ATTACK'; attackerId: string; targetId: string | 'DIRECT' }
  // Combined assault (multiple Vassals vs one Colossus):
  | { type: 'COMBINED_ATTACK'; attackerIds: string[]; targetId: string }
...
export type EngineEvent =
  ...
  | { type: 'COMBINED_ATTACK_DECLARED'; attackerIds: string[]; targetId: string }
  | { type: 'COMBAT_RESOLVED'; attackerId: string; targetId: string | 'DIRECT'; result: string }
  | { type: 'COMBINED_COMBAT_RESOLVED'; attackerIds: string[]; targetId: string; survivors: string[] }
